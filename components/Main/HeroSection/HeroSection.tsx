      ...
      <div className="relative w-full mx-auto">
        ...
        <div className="max-w-[40.75rem]">
          ...
          >
            ...
            knowledge of software development and project management. I'm adept
            at bringing all team members together to reach a common goal on time
            and under budget, conceptualizing software solutions with the best
            technology, design theory, and a large dose of creativity. I have
            helped many new programmers (virtually and physically) become
            proficient in their chosen programming language. I'm committed to
            viable and easily functional software solutions for clients.
          </m.p>
        </div>
        {/* buttons */}
        <m.div
